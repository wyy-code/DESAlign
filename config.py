...
class cfg():
    ...
    def get_args(self):
        ...
        parser.add_argument("--model_name", default="EVA", type=str, choices=["EVA", "MCLEA", "MSNEA", "DESAlign"], help="model name")
        ...
        # --------- DESAlign -----------
        parser.add_argument("--hidden_size", type=int, default=100, help="the hidden size of DESAlign")
        parser.add_argument("--intermediate_size", type=int, default=400, help="the hidden size of DESAlign")
        parser.add_argument("--num_attention_heads", type=int, default=5, help="the number of attention_heads of DESAlign")
        parser.add_argument("--num_hidden_layers", type=int, default=2, help="the number of hidden_layers of DESAlign")
        ...
        parser.add_argument("--att_abl", type=str, default="1.0", help="which visual adapt", choices=["0.05", "0.1", "0.15", "0.2", "0.3", "0.4",
                                                                                                    "0.45", "0.5", "0.55", "0.6", "0.7", "0.75", "0.8", "0.9", "0.95", "1.0"])
    ...
    def update_train_configs(self):
        ...
        if self.cfg.model_name not in ["DESAlign", "MSNEA", "EVA", "MCLEA"]:
